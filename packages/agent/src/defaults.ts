...
export const PERSONALITY_WEIGHTS: Record<Personality, number[]> = {
  ...
  loyalist:    [0.18, 0.05, 0.10, 0.08, 0.20, 0.03, 0.03, 0.02, 0.04, 0.02, 0.08, 0.04, 0.13],
  mercenary:   [0.12, 0.12, 0.03, 0.10, 0.16, 0.06, 0.03, 0.05, 0.03, 0.03, 0.04, 0.08, 0.15],
  provocateur: [0.08, 0.06, 0.03, 0.12, 0.20, 0.03, 0.02, 0.03, 0.02, 0.04, 0.04, 0.08, 0.25],
  scout:       [0.14, 0.08, 0.06, 0.06, 0.22, 0.03, 0.02, 0.04, 0.03, 0.04, 0.03, 0.06, 0.19],
  whale:       [0.16, 0.10, 0.04, 0.10, 0.18, 0.05, 0.03, 0.02, 0.03, 0.03, 0.05, 0.08, 0.13],
}
