...
export const PERSONALITY_WEIGHTS: Record<Personality, number[]> = {
  ...
  loyalist:    [0.20, 0.05, 0.10, 0.02, 0.22, 0.03, 0.03, 0.02, 0.04, 0.02, 0.08, 0.04, 0.15],
  mercenary:   [0.14, 0.14, 0.03, 0.03, 0.18, 0.06, 0.03, 0.05, 0.03, 0.03, 0.04, 0.08, 0.16],
  provocateur: [0.10, 0.06, 0.03, 0.03, 0.22, 0.03, 0.02, 0.03, 0.02, 0.04, 0.04, 0.08, 0.30],
  scout:       [0.16, 0.08, 0.06, 0.02, 0.24, 0.03, 0.02, 0.04, 0.03, 0.04, 0.03, 0.06, 0.19],
  whale:       [0.18, 0.12, 0.04, 0.03, 0.20, 0.05, 0.03, 0.02, 0.03, 0.03, 0.05, 0.08, 0.14],
}
