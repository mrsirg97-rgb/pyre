...
export const MIN_INTERVAL = parseInt(process.env.MIN_INTERVAL ?? (isMainnet ? '60000' : '30000'))
export const MAX_INTERVAL = parseInt(process.env.MAX_INTERVAL ?? (isMainnet ? '120000' : '60000'))
