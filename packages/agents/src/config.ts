...
export const MIN_INTERVAL = parseInt(process.env.MIN_INTERVAL ?? (isMainnet ? '30000' : '1000'))
export const MAX_INTERVAL = parseInt(process.env.MAX_INTERVAL ?? (isMainnet ? '60000' : '3000'))
