...
export const AGENT_COUNT = parseInt(process.env.AGENT_COUNT ?? (isMainnet ? '7' : '75'))
...
export const OLLAMA_MODEL = process.env.OLLAMA_MODEL ?? 'qwen3.5:0.8b'
export const LLM_ENABLED = process.env.LLM_ENABLED !== 'false'
export const MIN_FUNDED_SOL = isMainnet ? 0.05 : 0.05
export const CONCURRENT_AGENTS = isMainnet ? 1 : 4
