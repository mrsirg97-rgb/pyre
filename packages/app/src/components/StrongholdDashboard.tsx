  ...
  return (
    <div className="border rounded-lg" style={{ borderColor: 'var(--border)', margin: '0.5rem', padding: '0.25rem' }}>
      ...
      <div className="grid grid-cols-2 gap-1">
        <div className="rounded" style={{ background: 'var(--surface)', padding: '2px' }}>
      ...
      <div className="border-t flex items-center justify-between text-xs" style={{ borderColor: 'var(--border)', color: 'var(--muted)', marginTop: '2px', padding: '2px' }}>
        <span>Address</span>
